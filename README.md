...
```bash
# Go module
go get github.com/wau/wau-profile

# 或 clone + 手动 build
git clone https://github.com/XploreAlpha/wau-profile.git
cd wau-profile
go build ./...
```
...
# 2. 跑 self-test(若有 cmd/wau-profile/selftest)
go run ./cmd/wau-profile selftest
